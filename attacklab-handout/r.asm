...
00000000004019a0 <addval_273>:
  4019a0:	8d 87 48 89 c7 c3    	lea    -0x3c3876b8(%rdi),%eax   # mark: movl %eax %edi
  4019a6:	c3                   	retq   
...
00000000004019c3 <setval_426>:
  4019c3:	c7 07 48 89 c7 90    	movl   $0x90c78948,(%rdi)  # 4019c5  mark: movl %rax %rdi
  4019c9:	c3                   	retq   

00000000004019ca <getval_280>:
  4019ca:	b8 29 58 90 c3       	mov    $0xc3905829,%eax  # 4019cc:  popq %rax
  4019cf:	c3                   	retq   
...
0000000000401a39 <addval_110>:
  401a39:	8d 87 c8 89 e0 c3    	lea    -0x3c1f7638(%rdi),%eax   # mark: movl, %esp, %eax
  401a3f:	c3                   	retq   
