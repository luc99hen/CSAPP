...
0000000000400efc <phase_2>:
  400efc:	55                   	push   %rbp
  400efd:	53                   	push   %rbx
  400efe:	48 83 ec 28          	sub    $0x28,%rsp  # allocate 28 byte on stack
  400f02:	48 89 e6             	mov    %rsp,%rsi
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers> # use stack[0-24] for 6 numbers
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)  # stack[rsp] - 1 == 0
  400f0e:	74 20                	je     400f30 <phase_2+0x34>
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax  # eax: stack[rsp]
  400f1a:	01 c0                	add    %eax,%eax # eax: 2*eax
  400f1c:	39 03                	cmp    %eax,(%rbx) # stack[rsp+4] == eax
...
0000000000400f43 <phase_3>:
  ...
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx  # rcx: rsp+12 second digit
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx  # rdx: rsp+8 first digit
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi  # esi: 0x4025cf  "%d %d"
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax  # eax: 0x0
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  400f60:	83 f8 01             	cmp    $0x1,%eax
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>  # read two integers
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp) # first digit <= 7
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax # eax: first digit 
  ...
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax  # eax == second digit
...
0000000000400fce <func4>:
  ...
  400fd2:	89 d0                	mov    %edx,%eax  # eax: 15
  400fd4:	29 f0                	sub    %esi,%eax  # eax: 15-0
  400fd6:	89 c1                	mov    %eax,%ecx  # ecx: 15
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx # ecx: 0
  400fdb:	01 c8                	add    %ecx,%eax  # eax: 15
  400fdd:	d1 f8                	sar    %eax # only one argument means shift 1 bit, eax: 7
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx # ecx: 7
  400fe2:	39 f9                	cmp    %edi,%ecx # ecx - edi <= 0
  ...
  400ff7:	39 f9                	cmp    %edi,%ecx # ecx - edi <= 0
...
000000000040100c <phase_4>:
  ...
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi  # esi: 0x4025cf  "%d %d"
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  401029:	83 f8 02             	cmp    $0x2,%eax   # read two digits
  40102c:	75 07                	jne    401035 <phase_4+0x29>
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)  # first digit <= 15
  401033:	76 05                	jbe    40103a <phase_4+0x2e>
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx # edx: 15
  40103f:	be 00 00 00 00       	mov    $0x0,%esi # esi: 0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi # edi: first digit 
  401048:	e8 81 ff ff ff       	callq  400fce <func4>
  40104d:	85 c0                	test   %eax,%eax  # eax == 0
  40104f:	75 07                	jne    401058 <phase_4+0x4c>
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp) # second digit == 0
...
0000000000401062 <phase_5>:
  ...
  40107f:	83 f8 06             	cmp    $0x6,%eax  # input 6 characters
  401082:	74 4e                	je     4010d2 <phase_5+0x70>
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx  # ecx = *rbx
  40108f:	88 0c 24             	mov    %cl,(%rsp)   # *rsp = cl
  401092:	48 8b 14 24          	mov    (%rsp),%rdx  #  rdx = *rsp
  401096:	83 e2 0f             	and    $0xf,%edx    #  dl = cl
...
00000000004010f4 <phase_6>:
  ...
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers>  # rsp[0:24] = six numbers
  40110b:	49 89 e6             	mov    %rsp,%r14   # r14 = rsp
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d
  401114:	4c 89 ed             	mov    %r13,%rbp  # rbp = rsp
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax # eax = *rsp
  40111b:	83 e8 01             	sub    $0x1,%eax # eax -= 1
  40111e:	83 f8 05             	cmp    $0x5,%eax
  401121:	76 05                	jbe    401128 <phase_6+0x34>  # eax <= 6
  ...
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax # eax = next number
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)
  40113e:	75 05                	jne    401145 <phase_6+0x51> # next number != first number
  ...
  401162:	2b 10                	sub    (%rax),%edx # edx -= first number
  401164:	89 10                	mov    %edx,(%rax) # first n = 7 - first n
  ...
  40117d:	39 c8                	cmp    %ecx,%eax # ecx = first n
...
000000000040145c <read_six_numbers>:   # paras (rdi: input, rsi: callee prsp)
  40145c:	48 83 ec 18          	sub    $0x18,%rsp
  401460:	48 89 f2             	mov    %rsi,%rdx  # rdx:  prsp
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx # rcx: prsp+4
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax 
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp) # stack[rsp+8] = prsp+20
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax 
  401474:	48 89 04 24          	mov    %rax,(%rsp) # stack[rsp] = prsp+16
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9 # r9: prsp+12
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8 # r8: prsp+8
